    ...
    return (
      <div className="wrapper">
        ...
        <div className={cn('flex justify-center my-4')}>
          <button className={cn('bg-red-600 text-white font-montserrat py-2 px-8 font-medium rounded-xl hover:bg-red-500 transition-all duration-300 load-more-btn')} onClick={loadMore}>Load More</button>
        </div>
